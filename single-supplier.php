...
if (have_posts()) :
                            ...
                            <div class="row">
                                <div class="col-md-2 col-3">
                                    <?php if ( has_post_thumbnail() ): ?>
                                        <img src="<?php echo get_the_post_thumbnail_url( get_the_ID(), 'full' ); ?>" class="img-fluid" alt="<?php the_title(); ?>">
                                    <?php else: ?>
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo-dezon-black.jpeg" class="img-fluid" alt="Default Logo">
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="col-md-10 col-9">
                                    <div>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <?php if( $is_premium ): ?>
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/premium.png" style="width: auto; height: 30px;" alt="Premium Member">
                                            <?php endif; ?>
                                        </div>
                                            ...
                                            <div class="me-3">
                                                <a href="<?php echo esc_url($facebook_url); ?>" target="_blank" rel="nofollow">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                        ...
                                                        <path d="M24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 17.9895 4.3882 22.954 10.125 23.8542V15.4688H7.07812V12H10.125V9.35625C10.125 6.34875 11.9166 4.6875 14.6576 4.6875C15.9701 4.6875 17.3438 4.92188 17.3438 4.92188V7.875H15.8306C14.34 7.875 13.875 8.80008 13.875 9.75V12H17.2031L16.6711 15.4688H13.875V23.8542C19.6118 22.954 24 17.9895 24 12Z" fill="#80828D"/>
                                                        </g>
                                                        <defs><clipPath id="clip0_360_36694"><rect width="24" height="24" rx="12" fill="white"/></clipPath></defs>
                                                    </svg>
                                                </a>
                                            </div>
                                            <?php endif; ?>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="btn-style me-2">
                                    <a href="tel:<?php echo esc_attr($phone_number); ?>">
                                        ...
                                        <path d="M7.1875 4.47656L5.10254 6.97852C5.64983 8.21049 6.1045 8.96974 6.69238 9.55762C7.28026 10.1455 8.03951 10.6002 9.27148 11.1475L11.7734 9.0625L16.25 11.0518V16.25H15.625C10.5287 16.25 6.59117 14.9759 3.93262 12.3174C1.27407 9.65883 2.48436e-09 5.72134 0 0.625V0H5.19824L7.1875 4.47656ZM1.25684 1.25C1.35748 5.83274 2.57659 9.19183 4.81738 11.4326C7.05817 13.6734 10.4173 14.8925 15 14.9932V11.8643L11.9766 10.5205L9.48047 12.6006L9.12891 12.4492C7.65391 11.8171 6.62432 11.2591 5.80762 10.4424C4.99091 9.62568 4.43292 8.59609 3.80078 7.12109L3.64941 6.76953L5.72949 4.27344L4.38574 1.25H1.25684ZM8.95801 0C12.9851 0 16.25 3.26492 16.25 7.29199H15C15 3.95527 12.2947 1.25 8.95801 1.25V0ZM9.375 2.91699C11.5611 2.91699 13.333 4.68887 13.333 6.875H12.083C12.083 5.37923 10.8708 4.16699 9.375 4.16699V2.91699Z" fill="#1E1F24"/>
                                        </svg>
                                    </a>
                                </div>
                                <?php endif; ?>
        ...
        <div class="supplier_menu">
            <div class="container">
                <ul class="d-md-flex d-none">
                    ...
                    <li class="current-menu-item"><a href="">Dự án</a></li>
                    <li><a href="">Về chúng tôi</a></li>
                </ul>
                <div class="d-md-none d-block">
                    <div class="slider_breakcrumb">
                        <div class="item-breakcrumb active">
                            <a href="">Sản phẩm</a>
                        </div>
                        <div class="item-breakcrumb">
                            <a href="">Dự án</a>
                        </div>
                        <div class="item-breakcrumb">
    ...
    <div class="desc-supp section-padding pb-5">
        <div class="container">
            <div class="row">
    ...
    <div class="project_tt section-padding pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="sticky-top sticky-intro-label">
    ...
    // 2. Lấy TẤT CẢ sản phẩm của Supplier để tính toán danh mục
    ...
    // 3. Logic lấy danh mục và phân cấp (Đã FIX logic đếm cộng dồn)
    $related_cats = array();
    $terms_by_parent = array(); 
    $term_counts = array(); // Mảng tạm lưu số lượng
    ...
    if ( ! empty( $all_product_ids ) ) {
        ...
        if ( ! is_wp_error( $terms ) ) {
            // A. Đếm số lượng sản phẩm TRỰC TIẾP
            ...
            // B. (QUAN TRỌNG) Cộng dồn số lượng từ CON lên CHA
            // Chúng ta cần map parent cho tất cả term trước
            $term_map = array();
            ...
            foreach ($term_counts as $tid => $count) {
                if(isset($term_map[$tid])) {
                    ...
                    while($parent != 0 && isset($term_map[$parent])) {
                        ...
                        // Logic này tạm thời tính tổng số bài của cả nhánh con (có thể trùng lặp nếu 1 bài thuộc cả cha và con)
                        // Nhưng với Woocommerce thường 1 bài chỉ chọn 1 cấp hoặc chọn cả 2, WP Query tự handle unique.
                        // Để đơn giản hiển thị: ta cứ cộng dồn hoặc chỉ hiển thị số lượng trực tiếp. 
                        // Ở đây tôi giữ logic hiển thị số lượng có sản phẩm trực tiếp để tránh phức tạp.
                        
                        // Nếu muốn hiển thị danh mục cha kể cả khi nó rỗng (nhưng con có bài):
                        if(!isset($term_counts[$parent])) $term_counts[$parent] = 0; 
            ...
            foreach ( $terms as $term ) {
                // Hiển thị nếu term đó (hoặc con cháu nó) có sản phẩm
                // Để đơn giản, ta check nếu term có trong mảng count thì lấy
                ...
                <div class="col-lg-9">
                    ...
                    <div class="text-center mt-4 position-relative" style="z-index: 5;">
                        <button type="button" 
                                ...
                                class="btn btn-black rounded-pill fs-14 px-4 btn_view_more btn-intro-view"
                                data-supplier="<?php echo $supplier_id; ?>"
                                data-page="1"
                                data-max="<?php echo $products_query->max_num_pages; ?>"
                                data-cat="0"> Xem thêm
                        </button>
    ...
    <div class="partner_tt section-padding pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="sticky-top sticky-intro-label">
                        ...
                        <div class="col-xl-4 col-md-4">
                            <div class="list_partner mb-xl-0">
                                ...
                                <div class="d-flex mb-3 align-items-center">
                                    <img src="assets/images/partner-1.png" style="width: auto; height: 20px;" alt="">
                                    <p class="mb-0 ms-2">Post architecture inc.</p>
                                </div>
                                </a>
                                <a href="#" class="text-reset">
                                <div class="d-flex mb-3 align-items-center">
                                    <img src="assets/images/partner-2.png" style="width: auto; height: 20px;" alt="">
                                    <p class="mb-0 ms-2">Flansburgh Architects</p>
                                </div>
                                </a>
                                <a href="#" class="text-reset">
                                <div class="d-flex mb-3 align-items-center">
                                    <img src="assets/images/partner-3.png" style="width: auto; height: 20px;" alt="">
                                    <p class="mb-0 ms-2">Kuklinski + Rappe Architects</p>
                                </div>
                                </a>
                                <a href="#" class="text-reset">
                                <div class="d-flex mb-3 align-items-center">
                                    <img src="assets/images/partner-4.png" style="width: auto; height: 20px;" alt="">
                                    <p class="mb-0 ms-2">John Van Rooy Architeture</p>
                                </div>
                                </a>
                                <a href="#" class="text-reset">
                                <div class="d-flex mb-3 align-items-center">
                                    <img src="assets/images/partner-5.png" style="width: auto; height: 20px;" alt="">
                                    <p class="mb-0 ms-2">Space Exploration Design</p>
                                </div>
                                </a>
                            </div>
                        </div>
    ...
    <div class="figure_tt section-padding pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="sticky-top sticky-intro-label">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                ...
                                <a href="assets/images/product1.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product1.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 1">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product2.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product2.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 2">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product3.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product3.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 3">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product4.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product4.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 4">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product5.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product5.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 5">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product6.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product6.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 6">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product7.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product7.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 7">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product8.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product8.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 8">
                                </a>
                            </figure>
                        </div>
                        ...
                        <div class="col-lg-3 col-6">
                            <figure class="mb-0 rounded-2 overflow-hidden position-relative hover-zoom"
                                style="padding-bottom: 66.66%;">
                                <a href="assets/images/product9.jpg" data-fancybox="supplier-gallery"
                                    class="d-block w-100 h-100 position-absolute top-0 start-0">
                                    <img src="assets/images/product9.jpg"
                                        class="w-100 h-100 object-fit-cover transition-transform" alt="Gallery Image 9">
                                </a>
                            </figure>
                        </div>
    ...
    <div class="video_tt section-padding pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="sticky-top sticky-intro-label">
                            ...
                            <div class="col-lg-3">
                                <div class="item">
                                    <figure class="mb-0 position-relative rounded-3 overflow-hidden">
                                        <a href="#" class="d-block w-100 position-relative ratio-2-3">
                                        ...
                                        <div class="overlay-gradient-bottom">
                                            <h4 class="fs-24 fw-medium text-white mb-3 pe-auto"
                                                style="line-height: 1.4;">
                                                <a href="#" class="text-white text-decoration-none">Workshop Đồng Phù -
                                                    Ưu Đàm: Hành trình tái tạo không gian</a>
                                            </h4>
                                                ...
                                                <ul class="controls list-unstyled d-flex align-items-center gap-2 mb-0">
                                                    <li>
                                                        <a href="#" class="btn-play-video"
                                                            data-video-url="https://www.youtube.com/watch?v=VIDEO_ID_1">
                                                            <i class="fa fa-play fs-12 ms-1"></i>
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <span class="time-badge">74 phút</span>
                                                    </li>
                                                </ul>
                                                <div class="action">
                                                    <a href="#" class="btn-action-circle">
                                                        <img src="assets/images/dots.svg" class="img-fluid"
                                ...
                                <div class="item">
                                    <figure class="mb-0 position-relative rounded-3 overflow-hidden">
                                        ...
                                        <div class="overlay-gradient-bottom">
                                            <h4 class="fs-24 fw-medium text-white mb-3 pe-auto"
                                                style="line-height: 1.4;">
                                                <a href="#" class="text-white text-decoration-none">Talkshow: Xu hướng
                                                    thiết kế bền vững 2025</a>
                                            </h4>
                                            <div class="d-flex justify-content-between align-items-center pe-auto">
                                                <ul class="controls list-unstyled d-flex align-items-center gap-2 mb-0">
                                                    <li><a href="#" class="btn-play-video"><i
                                                                class="fa fa-play fs-12 ms-1"></i></a></li>
                                                    <li><span class="time-badge">45 phút</span></li>
                                                </ul>
                                                <div class="action">
                                                    <a href="#" class="btn-action-circle">
                                                        <img src="assets/images/dots.svg" class="img-fluid"
                                ...
                                <div class="item">
                                    <figure class="mb-0 position-relative rounded-3 overflow-hidden">
                                        ...
                                        <div class="overlay-gradient-bottom">
                                            <h4 class="fs-24 fw-medium text-white mb-3 pe-auto"
                                                style="line-height: 1.4;">
                                                <a href="#" class="text-white text-decoration-none">Behind the scenes:
                                                    Thi công dự án Ecopark Grand</a>
                                            </h4>
                                            <div class="d-flex justify-content-between align-items-center pe-auto">
                                                <ul class="controls list-unstyled d-flex align-items-center gap-2 mb-0">
                                                    <li><a href="#" class="btn-play-video"><i
                                                                class="fa fa-play fs-12 ms-1"></i></a></li>
                                                    <li><span class="time-badge">30 phút</span></li>
                                                </ul>
                                                <div class="action">
                                                    <a href="#" class="btn-action-circle">
                                                        <img src="assets/images/dots.svg" class="img-fluid"
                                ...
                                <div class="item">
                                    <figure class="mb-0 position-relative rounded-3 overflow-hidden">
                                        ...
                                        <div class="overlay-gradient-bottom">
                                            <h4 class="fs-24 fw-medium text-white mb-3 pe-auto"
                                                style="line-height: 1.4;">
                                                <a href="#" class="text-white text-decoration-none">Phỏng vấn độc quyền:
                                                    Tương lai của vật liệu xanh</a>
                                            </h4>
                                            <div class="d-flex justify-content-between align-items-center pe-auto">
                                                <ul class="controls list-unstyled d-flex align-items-center gap-2 mb-0">
                                                    <li><a href="#" class="btn-play-video"><i
                                                                class="fa fa-play fs-12 ms-1"></i></a></li>
                                                    <li><span class="time-badge">60 phút</span></li>
                                                </ul>
                                                <div class="action">
                                                    <a href="#" class="btn-action-circle">
                                                        <img src="assets/images/dots.svg" class="img-fluid"
    ...
    <div class="news_tt section-padding pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="sticky-top sticky-intro-label">
                ...
                <div class="col-lg-9">
                    <div class="space_post">
                        ...
                        <div class="row list_post">
                            <div class="col-lg-4">
                                <div class="post_item">
                                    <figure>
                                        <a href="">
                                            <img src="assets/images/cate1.jpg" class="img-fluid" alt="">
                                        </a>
                                    </figure>
                                    <div class="meta_info">
                                        <div class="row">
                                        ...
                                        <h4 class="fs-20 fw-semibold post_title"><a href="">Thiết kế vì con người:
                                                Khi
                                                không gian trở thành nơi nuôi dưỡng cảm xúc</a></h4>
                                        <div class="desc fs-14 cl-gray400">
                                            <p>Thảm Ký Ức Dệt trong nội thất thường chỉ những tác phẩm thảm nghệ
                                                thuật
                                                có xuất xứ từ các nền văn hóa lâu đời, được chế tác qua quy trình
                                                thủ
                                                công tinh xảo bằng vật liệu truyền thống như len, acrylic hoặc các
                                                sợi
                                                tự nhiên khác, vừa mang giá trị thẩm mỹ vừa lưu giữ các ký ức văn
                                                hóa,
                                                lịch sử.</p>
                                        </div>
                        ...
                        <div class="j_paging my-5 d-lg-block d-none">
                            <div class="wp-pagenavi" role="navigation">
                                <a class="prevpostslink" rel="prev" href="#">
                                    <img src="assets/images/first.svg" class="img-fluid" alt="">
                                </a>
                                ...
                                <a class="nextpostslink" rel="next" href="#">
                                    <img src="assets/images/last.svg" class="img-fluid" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <div class="document_tt section-padding pb-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <div class="sticky-top sticky-intro-label">
                ...
                <div class="col-lg-9">
                    <div class="row">
                         <div class="col-xl-4 col-md-4">
                            <div class="list_partner mb-xl-0 cl-blue">
                                <a href="#" class="text-reset">
                                    <div class="d-flex mb-3 align-items-center">
                                        <img src="assets/images/img-pdf.jpg" style="width: auto; height: 20px;" alt="">
                                        <p class="mb-0 ms-2">Post architecture inc.</p>
                                    </div>
                                </a>
                                <a href="#" class="text-reset">
        ...
        <div class="space_map">
            <div class="map_wrapper">
                ...
                <div class="nav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a href="javascript:void(0);" class="nav-link <?php echo $active_top_nav; ?>" 
                       id="v-pills-home-tab" 
                       data-bs-toggle="pill" 
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade <?php echo $active_top_content; ?>" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                        <div class="map_embed">
                            <iframe src="<?php echo esc_url($map['address_top']['link_map_embed']); ?>" 
                    ...
                    <div class="tab-pane fade <?php echo $active_bottom_content; ?>" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                        <div class="map_embed">
                            <iframe src="<?php echo esc_url($map['address_buttom_1']['link_map_embed']); ?>" 
                                    width="600" height="450" 
                                    style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                            </iframe>
                        </div>
...
<div class="space_banner">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    ...
                    ?>
                    <a href="<?php echo esc_url($btn_link); ?>" target="<?php echo esc_attr($target); ?>" rel="noopener noreferrer" class="btn btn-black fs-18">
    ...
    <img src="<?php echo esc_url($banner['background']); ?>" class="img-fluid" alt="<?php echo esc_attr($banner['title'] ?? 'Banner'); ?>" loading="eager" fetchpriority="high">
    <?php endif; ?>
</div>
<?php endif; ?>
...
<div class="space_page">
        ...
        <ul class="nav fs-18 justify-content-center nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" 
                    ...
                    data-fragment="<?php echo esc_attr($slug_tab_1); ?>" 
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link <?php echo (!$cspace_pro || empty($cspace_pro['title'])) ? 'active' : ''; ?>" 
                    ...
                    data-fragment="<?php echo esc_attr($slug_tab_2); ?>"
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
            ...
            <div class="space_overview">
                <div class="container">
                    <figure>
                        <img src="<?php echo esc_url($cspace_pro['space_overview']['image']); ?>" class="img-fluid" alt="" loading="lazy">
                    </figure>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="space_cate">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7">
                            <h3 class="fs-48 fw-medium"><?php echo esc_html($cspace_pro['title_cspace']['title_space_cate']); ?></h3>
                        </div>
                        <div class="col-lg-5">
                            ...
                            <a href="<?php echo esc_url($cspace_pro['title_cspace']['button_view_cate']['link']); ?>" class="btn btn-bgblack fs-18" target="_blank" rel="noopener noreferrer">
            ...
            <div class="space_comfor">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <h3 class="fs-48 fw-medium text-center title_group"><?php echo esc_html($com['title']); ?></h3>
                        </div>
                    </div>
                                ...
                                <div class="comfor_item">
                                    <figure>
                                        <a href="<?php echo esc_url($item['link'] ?? '#'); ?>" target="_blank" rel="noopener noreferrer">
                                            <img src="<?php echo esc_url($item['image']); ?>" class="img-fluid" alt="" loading="lazy">
                                        </a>
                                    </figure>
                                </div>
                            </div>
                    ...
                    <div class="text-center">
                        <a href="<?php echo esc_url($com['button']['link']); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-white">
                    ...
                    <div class="product_wrapper">
                        <div class="product_slider">
                            ...
                            <div class="item">
                                <figure>
                                    <a href="<?php echo get_permalink($pid); ?>" target="_blank" rel="noopener noreferrer">
                                        <img src="<?php echo esc_url($data['thumb_url']); ?>" class="img-fluid" alt="<?php echo esc_attr($data['post']->post_title); ?>" loading="lazy">
                                    </a>
                                </figure>
                                <div class="meta_info">
                            ...
                            <div class="item">
                                <figure>
                                    <a href="<?php echo get_permalink($pid); ?>" target="_blank" rel="noopener noreferrer">
                                        <img src="<?php echo esc_url($thumb_url); ?>" class="img-fluid" alt="<?php echo esc_attr($post_obj->post_title); ?>" loading="lazy">
                                    </a>
                                </figure>
                                <div class="meta_info">
                                    <h4 class="fs-20 fw-semibold">
            ...
            <div class="space_video">
                <div class="container">
                    <div class="video_wrapper">
                        <a href="<?php echo esc_url($video['link_youtube'] ?? '#'); ?>" data-fancybox="video-intro" class="d-block position-relative group-video">
                            <?php if (!empty($video['image'])) : ?>
                            <figure class="m-0">
                                <img src="<?php echo esc_url($video['image']); ?>" class="img-fluid w-100" alt="Video cover" loading="lazy">
                            </figure>
                            <?php endif; ?>
                            <div class="playvideo">
                ...
                <div class="container">
                    ...
                    <div class="about_wrapper">
                        ...
                        <div class="about_item <?php echo ($count == 1) ? 'active' : ''; ?>">
                            ...
                            <figure>
                                <img src="<?php echo esc_url($item_group['image']); ?>" class="img-fluid" alt="" loading="lazy">
                            </figure>
                            <div class="meta_info">
                    ...
                    <div class="splide__track">
                        <ul class="splide__list">
                            ...
                            <li class="splide__slide">
                                <div class="item">
                                    <img src="<?php echo esc_url($y['image']); ?>" class="img-fluid" alt="" loading="lazy">
                                </div>
                            </li>
                            <?php
                                endif;
                ...
                <div class="value_section">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                <figure>
                                    <img src="<?php echo esc_url($digit['image']); ?>" class="img-fluid" alt="" loading="lazy">
                                </figure>
                            </div>
                            <?php endif; ?>
                                    ...
                                    <div class="accordion-item">
                                        <div class="accordion-header">
                                            <a class="accordion-button fs-32 fw-medium <?php echo $is_first ? '' : 'collapsed'; ?>" 
                                               ...
                                               aria-expanded="<?php echo $is_first ? 'true' : 'false'; ?>">
                                                ...
                                                <img src="<?php echo esc_url($item['icon']); ?>" class="img-fluid me-2" alt="">
                                                <?php endif; ?>
                                        ...
                                        <div id="<?php echo $collapse_id; ?>" 
                                            ...
                                            <div class="accordion-body">
                                                <div class="fs-20 fw-medium"><?php echo nl2br(esc_html($item['excerpt'] ?? '')); ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endforeach; ?>
                        ...
                        <div class="number_content">
                            <div class="row justify-content-between">
                                <div class="col-lg-5">
                                    ...
                                    <?php endif; ?>
                                    <h3 class="fs-64 fw-medium title_group"><?php echo esc_html($number['title']); ?></h3>
                                    ...
                                    <div class="row digit_gap">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="digit_item">
                                                <div class="fs-18 fw-medium digit_title"><?php echo esc_html($x['item']['title']); ?></div>
                                                ...
                                                <div class="digit_in"><?php echo wp_kses_post($x['item']['desc']); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        <?php
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            ...
                            <div class="sub_title fs-18 text-center"><?php echo esc_html($solution['subtitle']); ?></div>
                            <?php endif; ?>
                            <h3 class="fs-64 fw-medium title_group text-center"><?php echo esc_html($solution['title']); ?></h3>
                        ...
                        <div class="row gx-lg-0">
                            ...
                            <div class="col-lg-3">
                                <div class="solution_item">
                                    <figure>
                                        <img src="<?php echo esc_url($x['image']); ?>" class="img-fluid" alt="" loading="lazy">
                                    </figure>
                                    <?php if (!empty($x['meta_info'])) : ?>
                                    <div class="meta_info">
                                        <h4 class="fs-48 fw-medium text-center"><?php echo esc_html($x['meta_info']); ?></h4>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-9 offset-lg-2">
                            <div class="row team_gap gx-lg-4 gx-2">
                                ...
                                <div class="col-lg-4 col-6">
                                    <div class="team_item">
                                        <figure>
                                            <img src="<?php echo esc_url($x['avatar']); ?>" class="img-fluid" alt="" loading="lazy">
                                        </figure>
                                        <div class="meta_info">
                                            <?php if (!empty($x['name'])) : ?>
                    ...
                    <div class="h-100 d-flex flex-column">
                        ...
                        <div class="contact_info fs-18">
                            ...
                            <ul>
                                ...
                                ?>
                                <li>
                                    <a href="<?php echo esc_url($x['link'] ?? '#'); ?>" target="_blank" rel="noopener noreferrer">
    ...
    <div class="space_map">
        <div class="map_wrapper">
            <div class="nav" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <?php if (!empty($map['address_top']['title'])) : ?>
                <a href="javascript:void(0);" class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                    <h4 class="fs-18 fw-semibold"><?php echo esc_html($map['address_top']['title']); ?></h4>
                    <?php if (!empty($map['address_top']['address'])) : ?>
                    <p class="fs-18">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/map.svg" class="img-fluid" alt="">
                ...
                <?php if (!empty($map['address_buttom_1']['title'])) : ?>
                <a href="javascript:void(0);" class="nav-link <?php echo empty($map['address_top']['title']) ? 'active' : ''; ?>" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                    <h4 class="fs-18 fw-semibold"><?php echo esc_html($map['address_buttom_1']['title']); ?></h4>
                    <?php if (!empty($map['address_buttom_1']['address'])) : ?>
                    <p class="fs-18">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/map.svg" class="img-fluid" alt="">
            ...
            <div class="tab-content" id="v-pills-tabContent">
                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab" tabindex="0">
                    <div class="map_embed">
                        <iframe src="<?php echo esc_url($map['address_top']['link_map_embed']); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
                <?php endif; ?>
                
                <?php if (!empty($map['address_buttom_1']['link_map_embed'])) : ?>
                <div class="tab-pane fade <?php echo empty($map['address_top']['link_map_embed']) ? 'show active' : ''; ?>" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                    <div class="map_embed">
                        <iframe src="<?php echo esc_url($map['address_buttom_1']['link_map_embed']); ?>" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
                <?php endif; ?>
            </div>
